...
const comparisons: OverviewDemoScopeComparison[] = [
  { id: "a", rank: 1, label: "改善小区", level: "AREA", score: 91, previousScore: 83, delta: 8, completeness: 100, storeCount: 2, mainChange: "Main improvement", currentConcern: "Concern" },
  { id: "c", rank: 2, label: "关注小区", level: "AREA", score: 61, previousScore: 70, delta: -9, completeness: 92, storeCount: 2, mainChange: "Main decline", currentConcern: "Concern" },
]
...
const issue = { id: "actions", label: "Action KPI 未达成", route: "/risk/actions", currentCount: 6, previousCount: 2, delta: 4, newIssueCount: 4, persistentIssueCount: 2, persistenceRate: 33, recoveredCount: 0, lifecycle: { current: 6, new: 4, persistent: 2, previous: 2, recovered: 0, delta: 4 }, affectedAreaCount: 3, totalAreaCount: 6, topAreaShare: 50, top2AreaShare: 80, top3AreaShare: 100, areaDistribution: [], affectedStores: [], conclusion: "集中" } satisfies OverviewDemoIssueView
...
describe("Overview Demo executive insights", () => {
  ...
  it("returns four visual signals and one concise executive note", () => {
    ...
    expect(result.declineSignal.detail).toBe("影响 1 家门店")
